...
public class Compra{
	...
	@Column(name = "com_stt_pagamento")
	private SttPagamento sttPagamento;

	@Enumerated(EnumType.STRING)
	@Column(name = "com_stt_transporte")
	private SttTransporte sttTransporte;
	
	@Enumerated(EnumType.STRING)
	@Column(name = "com_stt_troca")
	private SttTroca sttTroca;
